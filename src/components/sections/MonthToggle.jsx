...
const MonthToggle = React.memo(({ month, isOpen, onClick }) => {
  ...
  return (
    <FadeUp delay={0.3}>
      <div className="rounded-3xl border border-white/5 bg-betel-black px-6 py-8 shadow-lg md:p-8">
        {/* Cabeçalho do Toggle */}
        <div
        ...
        >
          ...
          <ChevronDown
            size={32}
            className={`text-betel-gold transition-transform duration-300 ${isOpen ? 'rotate-180' : 'rotate-0'}`}
          />
        </div>
